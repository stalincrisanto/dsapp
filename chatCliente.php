    ...
    <!-- Brand -->
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                ...
                <a class="nav-link" href="" style="color:#17a2b8!important;"><i class="fa fa-arrow-left" style="color: #17a2b8!important;"></i>&nbsp;Regresar</a>
            </li>
        </ul>
    </nav><br>
            ...
            <div class="col-lg-6 px-4 pb-4">
                ...
                <form action="" method="post" name="forma" id="forma">
                    ...
                    <div class="form-group">
                        ...
                        <input type="productos" class="form-control" name="productos" placeholder="Producto a comprar">
                    </div>
                    <div class="form-group">
                        <label for="direccion">Ingrese su dirección</label>
                        <input type="direccion" class="form-control" name="direccion" placeholder="Dirección del cliente">
                    </div>
